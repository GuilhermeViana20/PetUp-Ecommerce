        ...
        <Slide />
			...
			<div class="container">
				...
				<div class="col-lg-4 col-sm-12 col-md-12">
					<img src="@/assets/images/ecommerce/adsv.jpg" alt="Product big thumb"  class="img-fluid w-100">
				</div>
				...
				<div class="col-lg-4 col-sm-6 col-md-6">
					...
					<h4 class="mb-4 pb-3">Best selllers</h4>
							...
							<div class="media mb-3">
								...
								<img src="@/assets/images/ecommerce/p-1.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
							</a>
							...
							<div class="media mb-3">
								<a class="featured-entry-thumb" href="#">
								<img src="@/assets/images/ecommerce/p-2.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
							</a>
							<div class="media-body">
							...
							<div class="media mb-3">
							<a class="featured-entry-thumb" href="#">
								<img src="@/assets/images/ecommerce/p-3.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
							</a>
							<div class="media-body">
							...
							<div class="media mb-3">
								<a class="featured-entry-thumb" href="#">
								<img src="@/assets/images/ecommerce/p-4.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
							</a>
							<div class="media-body">
							...
							<div class="media">
								<a class="featured-entry-thumb" href="#">
								<img src="@/assets/images/ecommerce/p-5.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
							</a>
							<div class="media-body">
				...
				<div class="col-lg-4 col-sm-6 col-md-6">
					...
					<h4 class="mb-4 pb-3">New Arrivals</h4>
							...
							<div class="media mb-3">
								<a class="featured-entry-thumb" href="#">
								<img src="@/assets/images/ecommerce/p-7.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
							</a>
							<div class="media-body">
								<h6 class="featured-entry-title mb-0"><a href="#">Keds - Kickstart Pom Pom</a></h6>
								<p class="featured-entry-meta">$42.99</p>
							...
							<div class="media mb-3">
								<a class="featured-entry-thumb" href="#">
								<img src="@/assets/images/ecommerce/p-8.jpg" alt="Product thumb" width="64" class="img-fluid mr-3">
							</a>
							<div class="media-body">
								<h6 class="featured-entry-title mb-0"><a href="#">Nike - Brasilia Medium Backpack</a></h6>
								<p class="featured-entry-meta">$27.99</p>
